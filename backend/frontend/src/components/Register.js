    ...
    <div className="auth-container">
      <div className="auth-panel auth-form-container">
        <div>
          ...
          <p>Start organizing your tasks in minutes.</p>
          <form onSubmit={handleRegister} className="auth-form">
            <div className="input-group">
              <label htmlFor="name">Name</label>
              <input id="name" type="text" placeholder="Your Name" className="input-field" value={name} onChange={handleInputChange(setName)} required />
            </div>
            <div className="input-group">
            ...
            <div className="input-group">
              ...
              <div className="password-wrapper">
                <input id="password" type={showPwd ? 'text' : 'password'} placeholder="Minimum 6 characters" className="input-field" value={password} onChange={handleInputChange(setPassword)} required />
